<x-guest-layout>
    ...
    <div class="mx-auto max-w-4xl prose prose-lg">
        ...
        <p>Si vous souhaitez planifier un rendez-vous avec notre équipe, vous pouvez le faire en ligne en utilisant notre outil de prise de rendez-vous sur notre site web, ou vous pouvez nous appeler pendant nos heures d'ouverture régulières au [Numéro de Téléphone]. Nous ferons de notre mieux pour vous accueillir à un moment qui vous convient.</p>

        <p>Chez {{ config('app.name') }}, nous nous engageons à vous fournir des services de qualité supérieure et à rendre votre expérience avec nous aussi pratique que possible. Si vous avez des questions ou des préoccupations concernant nos horaires d'ouverture ou nos services, n'hésitez pas à <a href="{{ route('contact') }}">nous contacter</a></p>
