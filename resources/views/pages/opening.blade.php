<x-guest-layout>
    ...
    <div class="mx-auto max-w-4xl prose prose-lg">
        ...
        <p>Si vous souhaitez planifier un rendez-vous avec notre équipe, vous pouvez nous appeler pendant nos heures d'ouverture régulières au 04 78 67 54 39. Nous ferons de notre mieux pour vous accueillir à un moment qui vous convient.</p>
